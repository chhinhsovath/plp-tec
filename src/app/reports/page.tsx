        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-8 text-gray-600">Reports & Analytics</span>
            </div>
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8 flex justify-between items-center">
            <div>
              ...
              <p className="mt-2 text-gray-600">Monitor learning progress and system usage</p>
            </div>
            <div>
              <select
                value={timeRange}
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{analytics?.totalEnrollments || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{analytics?.averageProgress.toFixed(1) || 0}%</p>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <tr key={course.courseId}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                          course.averageProgress > 75 
                            ? 'bg-green-100 text-green-800' 
                            : course.averageProgress > 50 
                            ? 'bg-yellow-100 text-yellow-800'
                            : 'bg-red-100 text-red-800'
                        }`}>
                          {course.averageProgress > 75 ? 'Excellent' : course.averageProgress > 50 ? 'Good' : 'Needs Attention'}
                        </span>
                      </td>
                    </tr>
                  ))}
